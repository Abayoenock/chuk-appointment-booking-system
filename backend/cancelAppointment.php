...
if ($exe) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS => array('to' => "+25" . $phoneNumber, 'from' => 'E-Labs SMS', 'unicode' => '0', 'sms' => "Hello $usernames, you have successfuly cancelled your appointment that you had on $appointmentDate in $departmentName  department ", 'action' => 'send-sms'),
