    ...
    <div class="relative min-h-screen flex ">
        <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white  ">
            <div class="sm:w-1/2 xl:w-2/5 h-full hidden md:flex flex-auto items-center justify-start p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover back0 relative">
                ...
                <div class="w-full  max-w-md z-10">
                    ...
                    <div class="flex flex-col gap-4">
                        <p>You can book for the doctors appoinment if you have an account by logging in the system , if you don't have an account you can start by creating one </p>
                        <p>Having created an account you can book your appointment using any of the available choice </p>
                        <div class="flex gap-3 ">
                            <div class=" w-6 h-6 flex justify-center items-center rounded-md bg-opacity-50 text-white bg-cyan-600 text-md font-bold">
                                1 </div>
                            <p>Using
                                this
                                system by logging in and fill the form as required</p>
                        </div>
            ...
            <div class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full  xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white ">
                <div class="flex absolute gap-3 top-0 text-xl">
                    <a href="./doc/" class="py-1 px-3 bg-gradient-to-r from-green-400/70 to-blue-500/70  hover:bg-primary/80 rounded-b-lg  hover:bg-gradient-to-r hover:from-blue-400/70 hover:to-green-500/70 text-gray-100 " title="Doctor"> <i class="fa-solid fa-user-doctor"></i> </a>
                    <a href="./rec/" class="py-1 px-3  bg-gradient-to-r from-green-400/70 to-blue-500/70  hover:bg-primary/80 rounded-b-lg  hover:bg-gradient-to-r hover:from-blue-400/70 hover:to-green-500/70 text-gray-100 " title="Receptionist"> <i class="fa-solid fa-user-nurse"></i></a>
                    <a href="./admin/" class="py-1 px-3  bg-gradient-to-r from-green-400/70 to-blue-500/70  hover:bg-primary/80 rounded-b-lg  hover:bg-gradient-to-r hover:from-blue-400/70 hover:to-green-500/70 text-gray-100 " title="Admin"> <i class="fa-solid fa-user-shield"></i></a>
                </div>
                <div class="max-w-md w-full space-y-8">
                    ...
                    <form class="mt-8 space-y-6 submit" action="./backend/login.php" method="POST">
                        ...
                        <div class="relative">
                            ...
                            <label class="ml-0 text-sm font-bold text-gray-700 tracking-wide">Phone Number</label>
                            <input class="w-full mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900" type="tel" placeholder="Enter your phone number" type="" placeholder="07....." name="phoneNumber" value="" pattern="[0-9]{10}" required>
                        ...
                        <div class=" content-center">
                            <label class="ml-0 text-sm font-bold text-gray-700 tracking-wide">
                                Password
                            </label>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="reset-password" class="text-indigo-400 hover:text-blue-500">
                        ...
                        <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
                            ...
                            <a href="register" class="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign
                                up</a>
                        </p>
                    </form>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success == true) {
                            ...
                            sessionStorage.setItem("userSession", "1");
                            setTimeout(() => {
