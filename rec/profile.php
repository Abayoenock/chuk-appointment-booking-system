            ...
            <div class=" w-full md:ml-[250px] bg-white  h-screen overflow-y-auto flex flex-col mainContainer pb-40 p-6">
                ...
                <div class="w-full p-4 pb-0">
                    <p class=" bg-red-100 text-sm p-4 rounded-sm text-red-600">
                        ...
                        For security purpose you are only allowed to change the password, If you want to change any of the other onformation contact the administarator of he system
                    </p>
                </div>
                <div class="flex w-full gap-12 items-center p-4 pt-0">
                    ...
                    <form class="mt-12 mb-0 flex  gap-4 text-sm submit2 font-semibold w-full" action="#" method="POST" enctype="multipart/form-data">
