    ...
    <div class="md:flex items-center  min-h-screen w-full ">
        <div class=" flex items-center justify-center h-screen w-screen overflow-x-hidden ">
            ...
            <div class=" w-full md:w-1/2 p-4 md:p-8">
                ...
                <h2 class=" text-2xl font-bold tracking-wide text-primary">Confirm Your phone number </h2>
                <p class=" text-sm mt-2 p-4 bg-blue-100 text-blue-500 rounded-md">Hello <?php echo $usernames; ?> your account has been created successfuly , but you need to confirm your phone number to continue using our system, We have sent a confirmation code to your number copy the code below</p>


                <form class="my-8 md:w-4/6 flex flex-col gap-2 text-sm submit" action="./backend/verify.php" method="POST">

                    <div class="flex flex-col w-full ">
                        <label for="code" class="text-gray-700 font-semibold ">Confirmation Code </label>
