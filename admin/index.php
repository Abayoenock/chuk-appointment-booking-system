            ...
            <div class="sm:w-1/2 xl:w-2/5 h-full hidden md:flex flex-auto items-center justify-start p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover back0 relative">
                ...
                <div class="w-full  max-w-md z-10">
                    ...
                    <div class="flex flex-col gap-4">
                        <p>Your work has just been made easier , No more lots of people to at your door front seeking for an appointment You </p>
                        <p>Let the receptionist know the time of your availability in order to efficiently plan for appointments</p>
                ...
                <div class="max-w-md w-full space-y-8">
                    ...
                    <form class="mt-8 space-y-6 submit" action="./backend/login.php" method="POST">
                        ...
                        <div class="relative">
                            ...
                            <input class="w-full mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900" type="email" placeholder="Enter your password" placeholder="mail@gmail.com" name="email" value="" required>
